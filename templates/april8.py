...
<body>
    ...
    <script>
        ...
        // Force refresh the page after platform is added
        if (window.location.search.includes('platform=')) {
            // Clear the platform parameter from URL after page loads
